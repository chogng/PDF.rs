...
`pdf-rs/raster` is the pure Native integrated Reference renderer. It consumes one immutable
...
and terminal replay. `pdf-rs/scene` owns immutable semantic commands, resources, provenance,
