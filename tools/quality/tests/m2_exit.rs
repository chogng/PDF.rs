...
fn m2_ci_replays_fresh_profiles_before_exit_and_preserves_m1() {
    ...
    assert!(content_graphics_trace < debug_1);
    ...
    let shared_checks = "fmt,clippy,test,parser-mutation-smoke,case-manifests,m3-raster-oracle-contract,m3-content-graphics-trace,m2-scene-gate,m2-exit,m1-maturity,product-purity,product-release-closure,synthetic-failure-bundle";
