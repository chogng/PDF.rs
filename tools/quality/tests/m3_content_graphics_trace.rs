...
const REVIEWED_SUBJECTS: [(&str, &str); 12] = [
    (
        "pdf-rs/content/src/graphics_limits.rs",
    ...
    (
        "pdf-rs/content/tests/scanner.rs",
...
fn m3_content_graphics_plan_and_trace_registration_are_exact() {
    ...
    feature
        .expect_array("modules", &["pdf-rs/content", "pdf-rs/scene"])
        .expect("feature modules are exact");
    feature
        .expect_array(
            "tests",
            &[
                "pdf-rs/content::scanner",
                "pdf-rs/content::vm_graphics",
                "pdf-rs/content::repository_policy",
    ...
    assert_requirement(
        ...
        RequirementExpectation {
            ...
            implementation: &["pdf-rs/document", "pdf-rs/content", "pdf-rs/scene"],
            tests: &[
    ...
    assert_requirement(
        ...
        RequirementExpectation {
            ...
            implementation: &["pdf-rs/content", "pdf-rs/scene", "pdf-rs/raster"],
            tests: &[
                "pdf-rs/content::vm",
                "pdf-rs/content::vm_graphics",
                "pdf-rs/content::repository_policy",
    ...
    assert_requirement(
        ...
        RequirementExpectation {
            ...
            implementation: &["pdf-rs/content", "pdf-rs/scene"],
            tests: &[
                "pdf-rs/content::vm",
                "pdf-rs/content::vm_graphics",
                "pdf-rs/content::repository_policy",
                "pdf-rs/scene::scene_v1",
                "pdf-rs/scene::scene_v2",
                "tools/quality::m3_reference_gate",
                "tools/quality::m3_reference_raster_trace",
            ],
    ...
    assert_requirement(
        ...
        RequirementExpectation {
            ...
            tests: &[
                ...
                "pdf-rs/scene::scene_v1",
                "pdf-rs/scene::scene_v2",
                "pdf-rs/scene::scene_diff",
                "pdf-rs/scene::scene_diff_v2_budget",
                "pdf-rs/scene::repository_policy",
                "pdf-rs/raster::reference_foundation",
                "pdf-rs/raster::reference_scene_v2_boundary",
                "pdf-rs/raster::reference_geometry_kernel",
                "pdf-rs/raster::reference_color",
...
fn assert_requirement(document: &str, expected: RequirementExpectation<'_>) {
    ...
    if expected.features.contains(&"core.reference-raster-v1") {
        let integrated_position = expected_tests
            .iter()
            .position(|test| *test == "pdf-rs/raster::repository_policy")
            .or_else(|| {
                expected_tests
                    .iter()
