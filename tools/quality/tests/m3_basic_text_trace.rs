...
const REVIEWED_SUBJECTS: [(&str, &str); 41] = [
    ...
    (
        "pdf-rs/scene/src/graphics_builder.rs",
        "5bf83dace4df3418a704819478f7f05d7d89b9f3c4ea43ecceee46155e818af6",
    ),
    (
        "pdf-rs/scene/tests/repository_policy.rs",
    ...
    (
        "pdf-rs/raster/tests/reference_glyph.rs",
        "0cd00f13222b4663b0915678661762233e5e99fcb1cc94ac735be0903cbaa026",
    ),
    (
        "pdf-rs/raster/tests/reference_glyph_support/mod.rs",
        "58a0638de12a5dda589c7ba89fd2f2b75fe2abba25a9147913a23878c0ffab84",
    ),
    (
        "pdf-rs/raster/tests/repository_policy.rs",
...
fn m3_basic_text_ci_and_provenance_preserve_scope_and_m1() {
    ...
    for (path, markers) in [
        ...
        ("pdf-rs/document/PROVENANCE.md", &["Font", "FontFile2"][..]),
        ("pdf-rs/content/PROVENANCE.md", &["text", "glyph"][..]),
        ("pdf-rs/scene/PROVENANCE.md", &["glyph", "immutable"][..]),
        (
            "pdf-rs/raster/PROVENANCE.md",
