...
reference-chain capability into the catalog root.
...
the single-job reference-chain API and its aggregate accounting.
...
- Passing the Native object loop proves one generated traditional-table fixture
  ...
  or session-wide accounting. This test does not provide nested reference-graph
