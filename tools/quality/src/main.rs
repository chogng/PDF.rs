...
fn selection_for(lane: &str) -> Option<Selection> {
    match lane {
        "local" => Some(Selection {
            ...
            checks: "fmt,clippy,test,parser-mutation-smoke,case-manifests,m3-raster-oracle-contract,m3-content-graphics-trace,m3-reference-geometry-trace,m3-reference-color-trace,m2-scene-gate,m2-exit,m1-maturity,product-purity,product-release-closure,synthetic-failure-bundle",
        }),
        "pr" => Some(Selection {
            lane: "pr",
            reason: "merge gate for the complete required Rust quality baseline",
            checks: "fmt,clippy,test,parser-mutation-smoke,case-manifests,m3-raster-oracle-contract,m3-content-graphics-trace,m3-reference-geometry-trace,m3-reference-color-trace,m2-scene-gate,m2-exit,m1-maturity,product-purity,product-release-closure,synthetic-failure-bundle,doc",
        }),
        _ => None,
    }
}
